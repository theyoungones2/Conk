...
To correct this in [GlobalVars.c](../../Gonk/Source/GlobalVars.c) we define the System Libraries as `struct DosLibrary * __near DOSBase;
` to force a 16 bit reference.  
