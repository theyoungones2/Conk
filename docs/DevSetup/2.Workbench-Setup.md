...
- Floppy Drives
  ...
  - ![Workbench Floppy](../img/workbench-floppy.png)
- Start
...
- Quick Format
- ![Workbench Format DH0](../img/workbench-format-dh0.png)
...
Multiscan monitor setup
- Copy Storage/Monitors/Multiscan in to Devs/Monitors
- Reset
